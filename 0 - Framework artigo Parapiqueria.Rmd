...
lamb_df%>%statrep(., group_vars = c("Site","Year"),value_var = "Lambda")
...
```{r}
LTRE(mean(mpm_list_S11B), mean(mpm_list_S11C))
```
...
projS11B_30<-stoch.projection(mpm_list_S11B, 
...
projS11C_30<-stoch.projection(mpm_list_S11C, 
                              n_init,tmax=30,nreps=1000)

...
-   **Must run in order to determine C, non-zero elements and b which will be used to estimate survival**
    ...
    -   Matrix is
        ...
        -   Does note includes recruitment because it cannot be estimated within year (March-May)
...
viab_para<-do.call(rbind,out)%>%
  mutate(Persist.rate=100-(Extinct.rate*100),
         ymin=100-((Persist-SD)*100),
         ymax=100-((Persist+SD)*100))
